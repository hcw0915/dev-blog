...
export const translations = {
  zh: {
    ...
    playground: {
      ...
      draftSaved: '已自動儲存',
      draftClean: '未修改',
      draftHint: '每次修改都會自動存到這個瀏覽器；檔名變黃並標 M 代表跟原始檔不同，按「還原」可回到原始版本',
      backToList: '← 返回列表',
  ...
  en: {
    ...
    playground: {
      ...
      draftHint: 'Every edit is auto-saved in this browser; a yellow name with M means it differs from the original — use Reset to restore',
