...
export const translations = {
  zh: {
    ...
    playground: {
      ...
      draftSaved: '草稿已儲存',
      draftClean: '未修改',
      draftHint: '草稿存在這個瀏覽器的 localStorage，不會寫回原始檔；按「還原」可回到原始版本',
      backToList: '← 返回列表',
  ...
  en: {
    ...
    playground: {
      ...
      draftHint: 'Drafts live in this browser\'s localStorage and never write back to the originals; use Reset to restore',
